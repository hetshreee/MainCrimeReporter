...
public class UserEditProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*Spinner spinneroption = (Spinner) findViewById(R.id.usereditprofilespinneropt);
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(UserEditProfile.this,
                android.R.layout.activity_list_item, getResources().getStringArray(R.array.names));
        myAdapter.setDropDownViewResource(android.R.layout.activity_list_item);
        spinneroption.setAdapter(myAdapter);*/
